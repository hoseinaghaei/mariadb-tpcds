...
--
--  Range in this file : 0.0s .. 0.5s
--  Total for this file: 5.1s
--  Queries            : 92, 3, 19, 32, 52, 55, 24, 42, 53, 63, 12, 28, 40, 56, 81, 84, 89, 30, 41
--
...
-- --------------------------------------------------------------------------
-- query92   indexed 0.0s   base 0.2s   -
-- --------------------------------------------------------------------------
select  
...
-- --------------------------------------------------------------------------
-- query19   indexed 0.1s   base 0.2s   2.00x
-- --------------------------------------------------------------------------
...
-- --------------------------------------------------------------------------
-- query52   indexed 0.1s   base 0.2s   2.00x
-- --------------------------------------------------------------------------
select  dt.d_year
 	,item.i_brand_id brand_id
 	,item.i_brand brand
...
-- --------------------------------------------------------------------------
-- query24   indexed 0.2s   base 18.6s   93.00x
-- --------------------------------------------------------------------------
with ssales as
(select c_last_name
      ,c_first_name
...
-- --------------------------------------------------------------------------
-- query42   indexed 0.2s   base 0.2s   1.00x
-- --------------------------------------------------------------------------
select  dt.d_year
 	,item.i_category_id
 	,item.i_category
...
-- --------------------------------------------------------------------------
-- query53   indexed 0.2s   base 0.2s   1.00x
-- --------------------------------------------------------------------------
select  * from 
...
-- --------------------------------------------------------------------------
-- query63   indexed 0.2s   base 0.5s   2.50x
-- --------------------------------------------------------------------------
select  * 
...
-- --------------------------------------------------------------------------
-- query12   indexed 0.4s   base 0.6s   1.50x
-- --------------------------------------------------------------------------
select  i_item_id
      ,i_item_desc 
      ,i_category 
...
-- --------------------------------------------------------------------------
-- query28   indexed 0.4s   base 35.4s   88.50x
-- --------------------------------------------------------------------------
select  *
...
-- --------------------------------------------------------------------------
-- query40   indexed 0.4s   base 0.4s   1.00x
-- --------------------------------------------------------------------------
select  
   w_state
  ,i_item_id
...
-- --------------------------------------------------------------------------
-- query56   indexed 0.4s   base 1.1s   2.75x
-- --------------------------------------------------------------------------
with ss as (
...
-- --------------------------------------------------------------------------
-- query81   indexed 0.4s   base 0.8s   2.00x
-- --------------------------------------------------------------------------
...
-- --------------------------------------------------------------------------
-- query84   indexed 0.4s   base 13.0s   32.50x
-- --------------------------------------------------------------------------
...
-- --------------------------------------------------------------------------
-- query89   indexed 0.4s   base 0.6s   1.50x
-- --------------------------------------------------------------------------
select  *
from(
...
-- --------------------------------------------------------------------------
-- query30   indexed 0.5s   base 0.6s   1.20x
-- --------------------------------------------------------------------------
with customer_total_return as
...
-- --------------------------------------------------------------------------
-- query41   indexed 0.5s   base 0.7s   1.40x
-- --------------------------------------------------------------------------
